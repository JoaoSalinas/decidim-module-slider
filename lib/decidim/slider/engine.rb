...
module Decidim
  module Slider
    ...
    class Engine < ::Rails::Engine
      ...
      initializer "slider.register_icons" do |_app|
        Decidim.icons.register(name: "slideshow-line", icon: "slideshow-line", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "pencil", icon: "pencil-line", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "x", icon: "delete-bin-line", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "menu", icon: "menu-line", category: "system", description: "", engine: :admin)
        
        Decidim.icons.register(name: "chevron-left", icon: "arrow-left-s-line", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "chevron-right", icon: "arrow-right-s-line", category: "system", description: "", engine: :core)
      end
    end
  end
end
